package utils.customCode.BarChar;
...
public class Chart extends javax.swing.JPanel {
    ...
    public Chart() {
        ...
        animator = new Animator(1000, target); //set thời gian để đi từ 0 -> vị trí cuối
        animator.setResolution(0); //độ mượt của animation, càng thấp càng mượt
        ...
        blankPlotChart.setBlankPlotChatRender(new BlankPlotChatRender() {
            ...
            public void renderSeries(BlankPlotChart chart, Graphics2D g2, SeriesSize size, int index) {
                ...
                for (int i = 0; i < legends.size(); i++) {
                    ...
                    double seriesValues = chart.getSeriesValuesOf(model.get(index).getValues()[i], size.getHeight()) * animate; //animation sẽ được thể hiện ở dòng này, thay đổi theo frame và repaint lại
