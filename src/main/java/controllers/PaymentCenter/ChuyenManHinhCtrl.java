...
import views.main.PaymentCenter.DSHoaDonDaThucHienGiaoDich;
import views.main.PaymentCenter.ThongTinTaiKhoan;
import views.main.PaymentCenter.ThuTien;
        ...
        public void mouseClicked(MouseEvent e) {
            switch (kind) {
                case "Home":
                    ...
                    break;
                case "Bill":
                    node = new DSHoaDonDaThucHienGiaoDich();
                    break;
                case "Info":
                    node = new ThongTinTaiKhoan();
                    break;
                case "LogOut":
                    node = new ThuTien();
                    break;                
