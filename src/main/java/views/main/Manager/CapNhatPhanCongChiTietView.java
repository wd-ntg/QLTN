 ...
 * @author GIANG
 */
public class CapNhatPhanCongChiTietView extends javax.swing.JFrame {

    /**
     * Creates new form UpdateAssignmentEmployDetail
     */
    List<NhanVienModel> nhanVienModel = new ArrayList<>();
    

    NhanVienModel capNhatPhanCongNhanVienModel = new NhanVienModel();

    DefaultTableModel tableModel;

    public CapNhatPhanCongChiTietView() {
        try {
            initComponents();
            ...
            hienThiDSNhanVien(DataGlobal.getDataGLobal.dataGlobal.getKhuVucModel().getMAKHUVUC());
        } catch (Exception e) {
            Logger.getLogger(CapNhatPhanCongChiTietView.class.getName()).log(Level.SEVERE, null, e);
        }
    }
    ...
    public void setLabelDisplay() {
        ...
        if (nonphancong.equals("AC")) {
            try {
                ...
                currentIDUser.setText(phanCongModel.getMACH());
                currentDetailAddressUser.setText(phanCongModel.getTENDIACHI());
                currentPhoneNumberUser.setText(phanCongModel.getSDTCH());
                currentUserEmail.setText(phanCongModel.getEMAILCH());
                currentTypeWaterUser.setText(phanCongModel.getTENLOAINUOC());
                currentNameEmployer.setText(phanCongModel.getHOTENNV());
                currentIDEmployer.setText(phanCongModel.getMANV());
                currentEmailEmployer.setText(phanCongModel.getEMAILNV());
                currentPhoneNumberEmployer.setText(phanCongModel.getSDTNV());
            } catch (Exception ex) {
                Logger.getLogger(CapNhatPhanCongChiTietView.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
            try {
                PhanCongModel phanCongModel = CapNhatPhanCongChiTietCtrl.timThongTinHienThiCapNhatPhanCong(DataGlobal.getDataGLobal.dataGlobal.getPhanCongModel().getMAPC(), DataGlobal.getDataGLobal.dataGlobal.getTimeAssign());
    ...
    public void hienThiDSNhanVien(String maKhuVuc) throws ClassNotFoundException {

        nhanVienModel = CapNhatPhanCongChiTietCtrl.timTatCaNhanVienTrucThuocKhuVuc(maKhuVuc);

        tableModel.setRowCount(0);

        nhanVienModel.forEach(NV -> {
            tableModel.addRow(new Object[]{NV.getMANV(), NV.getHOTEN(), NV.getEMAIL(), NV.getSDT()});
        });
    ...
    private void updateReplaceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateReplaceActionPerformed
        ...
        try {
            CapNhatPhanCongChiTietCtrl.capNhatThongTinPhanCongNhanVienChiTiet(capNhatPhanCongNhanVienModel.getMANV(), DataGlobal.getDataGLobal.dataGlobal.getPhanCongModel().getMAPC(), DataGlobal.getDataGLobal.dataGlobal.getTimeAssign());
            setLabelDisplay();
    ...
    private void tableAssignmentEmployerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableAssignmentEmployerMouseClicked
        ...
        if (selectedIndex >= 0) {
            try {
                ...
                capNhatPhanCongNhanVienModel = nhanVienModel.get(selectedIndex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CapNhatPhanCongChiTietView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CapNhatPhanCongChiTietView().setVisible(true);
            }
        });
    }
