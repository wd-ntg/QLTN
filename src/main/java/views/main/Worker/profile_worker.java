...
public class profile_worker extends javax.swing.JPanel {
    ...
    public void setDefault(){
        ...
        lb_id.setText(nhanVienModel.getMaNV());
        lb_name.setText(nhanVienModel.getHoTen());
        lb_gioiTinh.setText(nhanVienModel.getGioiTinh());
        lb_phoneNo.setText(nhanVienModel.getSdt());
        lb_email.setText(nhanVienModel.getEmail());
        
        //---set chi nhanh nhan vien----
        lb_branch2.setText("Chi nhánh " + workerController.getBranchWork(nhanVienModel.getMaKV()));
        //-------------------------------
    }
    ...
    private void initComponents() {
        ...
        lb_gioiTinh.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        lb_gioiTinh.setText("84, Man Thiện, Tân Phú, Tp.HCM");
    ...
    private void button_changePasswordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_changePasswordActionPerformed
        ...
        GlobalData.getInstance().setStack("INFOR");
