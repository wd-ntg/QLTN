...
public class workerMain extends javax.swing.JFrame {
    ...
    private final editPassword_worker editPassword_worker1 = new editPassword_worker(this);
    ...
    private final profile_worker profile_worker1 = new  profile_worker(this);
    private GhiDienSoNuoc ghiDienSoNuoc = new GhiDienSoNuoc(this);
    private DienSoNuoc dienSoNuoc = new DienSoNuoc(this);
    ...
    public void setVisibleStack(){
        setVisibleAllFalse();
        switch (GlobalData.getInstance().getStack()) {
    ...
    private void button_homeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_homeActionPerformed
        GlobalData.getInstance().clearStack();
        setVisibleHome(true);
    ...
    public void setChuHoInfor_DienSoNuoc(ChuHoModel chuHoModel_dsn){
        ghiDienSoNuoc.setChuHoModel(chuHoModel_dsn);
    }
    
    public void setBillsChuHo_DienSoNuoc(ChuHoModel chuHoModel_gdsn){
        dienSoNuoc.setChuHoModel(chuHoModel_gdsn);
    }
